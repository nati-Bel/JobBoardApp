<x-layout>
    <x-breadcrumbs :links="['My Jobs'=>route('my-job.index'), 'Create' => '#']"/>
        ...
        <form action="{{route('my-job.store')}}" method="POST">
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-radio-group name="experience" :allOption="false" :value="old('experience')"
                ...
                <div>
                    ...
                    <x-radio-group name="experience" :allOption="false" :value="old('category')"
